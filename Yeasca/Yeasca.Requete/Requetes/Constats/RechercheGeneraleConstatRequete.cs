...
{
    public class RechercheGeneraleConstatRequete : Requete<IRechercheGeneraleConstatMessage>
    {
        public override ReponseRequete exécuter(IRechercheGeneraleConstatMessage message)
        {
            if (estAuthentifié())
            {
