...
namespace Yeasca.TestsUnitaires.Constats
{
    ...
    public class TestAdresse
    {
        ...
        public void TestAdresse_uneAdresseVideRenvoieUneListeDerreursRemplie()
        {
            ...
            Assert.AreNotEqual(0, uneAdresseVide.obtenirLesErreurs().donnerLaListeDesErreurs().Count);
        }
        ...
        public void TestAdresse_uneAdresseValideRetourneUneListeDErreursVide()
        {
            ...
            Assert.AreEqual(0, uneAdresseValide.obtenirLesErreurs().donnerLaListeDesErreurs().Count);
        }
        ...
        {
            Adresse uneAdresseVide = new Adresse();
            List<string> messagesDErreur = uneAdresseVide.obtenirLesErreurs().donnerLaListeDesErreurs();
        ...
        public void TestAdresse_uneAdresseAvecDesValeursTropLonguesRenvoieLesBonsMessagesDErreur()
        {
            ...
            Adresse uneAdresseAvecValeursTropLongues = new Adresse(
                ...
                ConstantesTest.CHAINE_DE_6,
                ConstantesTest.CHAINE_DE_256);
            List<string> messagesDErreur = uneAdresseAvecValeursTropLongues.obtenirLesErreurs().donnerLaListeDesErreurs();
        ...
        public void TestAdresse_uneAdresseAvecDesDonnéesInvalidesRenvoieLesBonsMessagesDErreur()
        {
            ...
            List<string> messagesDErreur = uneAdresseAvecDonnéesInvalide.obtenirLesErreurs().donnerLaListeDesErreurs();
        ...
        private void testerLaValeurOptionnelleRequisePourLeNuméroDeVoie()
        {
            ...
            List<string> messagesDErreur = uneAdresseAvecDonnéeOptionnelleRequise.obtenirLesErreurs().donnerLaListeDesErreurs();
