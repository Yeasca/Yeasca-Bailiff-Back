...
namespace Yeasca.TestsUnitaires.Constats
{
    ...
    public class TestPartie
    {
        ...
        {
            PartieMock unePartieVide = new PartieMock();
            List<string> messagesDErreurs = unePartieVide.obtenirLesErreurs().donnerLaListeDesErreurs();
        ...
        public void TestPartie_unePartieAvecDesDonnéesTropLonguesRenvoieLesBonsMessagesDErreur()
        {
            ...
            List<string> messagesDErreurs = unePartieAvecDonnéesTropLongues.obtenirLesErreurs().donnerLaListeDesErreurs();
    ...
    public class PartieMock : Profile
    {
